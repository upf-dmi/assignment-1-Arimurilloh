...
heart_data <- read.csv("C:/Users/arian/Documents/GitHub/assignment-1-Arimurilloh/data/heart_disease_dataset.csv", sep = " ", header = TRUE, na.strings = c("?"))
...
```{r}
data <- read_excel("C:/Users/arian/Documents/GitHub/assignment-1-Arimurilloh/data/data_covid19.XLSX", col_names = TRUE) #Load data
...
```{r}
# Read excel:
df <- read_excel("C:/Users/arian/Documents/GitHub/assignment-1-Arimurilloh/data/data2_covid19.XLSX", col_names = TRUE, na=c("NI", "ND"), skip = 1) #skip 1st line (not header)
